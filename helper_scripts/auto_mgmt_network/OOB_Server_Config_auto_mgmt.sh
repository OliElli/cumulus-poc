...
REPOSITORY="https://github.com/CumulusNetworks/vx-simulation"
REPONAME="vx-simulation"
...
install_puppet(){
    ...
    sed -i 's/172.17.192.250/172.17.192.250 puppet /g'>> /etc/hosts
}
...
#sudo bash -c 'echo "certname = 172.17.192.250" >> /etc/puppetlabs/puppet/puppet.conf'
